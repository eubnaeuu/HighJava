...
<head>
	...
	<link rel="stylesheet" href="/MemberPj/css/newcss.css">
	<!-- JS -->
	<script src="/MemberPj/js/jquery-3.6.0.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/MemberPj/js/common/myutils.js?v=1"></script>
...
<!-- 			<input type="hidden" name="action" id="actionFm"> -->
		...
		<div class="form-button text-center">
			<button type="button" class="btn btn-primary" onclick="save()">제출</button>
