...
<script type="text/javascript">
	function fn_selectMessageTo(vara){
		...
		$(this).attr("name","tmp");
		$("#receiveMemStr").attr("name","receiveMem");
		} else{
		$(this).attr("name","receiveMem");
		$("#receiveMemStr").attr("name","tmp");
		}
		}
		function winclose(){
		window.close();
...
<body>
	<div class="container" style="width: 300px">
		...
		<table class="tabletable-hover">
			...
			<tr>
				<td width="50px">TO</td>
				<td><select id="receiveMemSelect"
					onchange="fn_selectMessageTo(this)" name="receiveMem">
						<%
							if (friendlist != null) {
								int cnt = 0;
						%>
