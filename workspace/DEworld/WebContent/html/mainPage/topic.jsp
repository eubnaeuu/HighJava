	...
	<div>
		...
		<div class="container">
			<nav class="nav nav-pills nav-justified" id="mainButton">
				<a class="nav-link active" href="#" id="btnTopic" onclick="mainAreaClick()">TOPIC</a> 
				<a class="nav-link" href="#" id="btnShop" onclick="mainAreaClick()">SHOP</a>
				<a class="nav-link" href="#" id="btnMypage" onclick="mainAreaClick()">MY PAGE</a>
			</nav>
			<br>
			<nav class="nav nav-pills nav-justified" id="shopDetail">
				<a class="nav-link active" href="#" id="btnMusic" onclick="subAreaClick()">MUSIC</a>
				<a class="nav-link" href="#" id="btnTheme" onclick="subAreaClick()">THEME</a>
				<a class="nav-link" href="#" id="btnMinimi" onclick="subAreaClick()">MINIMI</a>
			</nav>
			<hr>
		</div>
	</div>
						...
						<div class="col-md-6 mb-5">
							<div class="card h-100">
								...
								<div class="card-body">
									...
									<p class="card-text">대충 설명ㅁㄴㅇㅁㄶㅇ ㅎ뢰아ㅓ; ㅏ시ㅏㅛㅣ마ㅓㅚㅏ기ㅘ싀ㅏㅡ퓰니
										ㅏㄴ;일,ㅍㄴㅇ륜로</p>	
								</div>
								<div class="card-footer">
									<a href="#" class="btn btn-primary">미니홈피로 가기</a>
								</div>
							</div>
						</div>
						<div class="col-md-6 mb-5">
							...
							<div class="card-body" style="">
								<div>
									<span class="btn btn-primary col-md-5" style="" onclick="goMyMessage()">쪽지</span>
										<a href="#" class="btn btn-primary col-md-5" style="float: right">충전하기</a>
								</div>
								<br>
								<div>
									<a href="#" class="btn btn-primary col-md-5">내 일촌</a> <a
										href="#" class="btn btn-primary col-md-5" style="float: right">구매내역
										조회</a>
								</div>
							</div>
						</div>
