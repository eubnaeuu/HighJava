					...
					<table border="0" align="left" width="800" height="510"
						...
						<tr>
							<td colspan="2" align="center"><br> <font face="굴림"><span
									style="font-size: 8pt;">today<%=hompiCountTod %> total<%=hompiCountTot %></span></font></td>
							<td height="40"><br> <font face="굴림"><span
									style="font-size: 13pt; font-weight: bold">
										<center>
											<font color="#4B9687">"<%=hompiinfo.getMemNickname() %>"님의 미니 홈페이지</font>
										</center>
								</span></font></td>
							<td></td>
						</tr>
						<tr>
							...
							<td width="480" height="450"
								...
								<center>
									...
									<iframe frameborder="0" width="470" height="430"
										src="/DEworld/html/hompi/r_home.jsp?hompiId=<%=hompiId%>" id="rightIframe"></iframe>
									<!-- ---------------------------------------------------------------------------- -->
								</center>
							</td>
							<!-- 오른쪽 메뉴 부분 ----------------------------------------------------------- -->
							<td>
								<button type="button" class="btm_image" id="img_btn"
									onclick="iframeChange('/DEworld/html/hompi/r_home.jsp?hompiId=<%=hompiId%>')">홈</button> <br />
								<br />
								<button type="button" class="btm_image" id="img_btn"
									onclick="iframeChange('/DEworld/html/hompi/r_profile.jsp?hompiId=<%=hompiId%>')">프로필</button> <br />
								<br />
								<button type="button" class="btm_image" id="img_btn"
