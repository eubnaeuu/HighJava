...
public class NoticeServlet extends HttpServlet{
	...
	try {
		if("L".equals(flag)) { // 목록조회
			...
			List<NoticeVO> list = deleteNoticeList(req);
...
//		}
	...
	private List<NoticeVO> deleteNoticeList(HttpServletRequest req) {
		String strNoticeNoArr = req.getParameter("noticeNoArr");
//		int[] noticeNoArr = req.getParameter("noticeNoArr");
//		for (int i = 0; i < noticeNoArr.length; i++) {
//			System.out.println(noticeNoArr[i]);
//		}
		return null;
	}
