...
public class ItemCollectionServiceImpl implements IItemCollectionService {
	...
	private static IItemCollectionService service;
	
	private ItemCollectionServiceImpl() {
		itemDao = ItemCollectionDaoImpl.getInstance();
		smc = SqlMapClientUtil.getInstance();
	}
	
	public static IItemCollectionService getInstance() {
		if(service == null) {
			service = new ItemCollectionServiceImpl();
		}
