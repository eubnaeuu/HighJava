...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	// 예외 객체
	Throwable thrwoable = (Throwable) req.getAttribute("javax.servliet.error.exception"); // 해당 attribute의 value 반환ㄴ
	...
	if(thrwoable == null && statusCode == null) {
		...
		out.println("예외 타입 ㅣ "  + thrwoable.getClass().getName()+"<br><br>");
		out.println("요청 URI : " + requestUri + "<br><br>" );
		out.println("예외 메시지 : " + thrwoable.getMessage());
	}
	out.println("</body>");
	out.println("</html>");
}
